...
This is the index for platform backlog items. Each detailed backlog file lives under `docs/todo/`.
...
- [TODO_04_learning_experience_and_accessibility.md](todo/TODO_04_learning_experience_and_accessibility.md) - learner/instructor workflows, accessibility, localization, and dashboards
- [TODO_05_interoperability_quality_and_research.md](todo/TODO_05_interoperability_quality_and_research.md) - standards, test fixtures, analytics, and research-informed evaluation

## Readiness Backlog

- [TODO_06_runnable_teaching_cli.md](todo/TODO_06_runnable_teaching_cli.md) - minimal end-to-end learner-facing teaching session
- [TODO_07_learner_state_persistence_and_privacy.md](todo/TODO_07_learner_state_persistence_and_privacy.md) - durable learner state, privacy, auditability, and sync safety
- [TODO_08_ai_teacher_model_integration.md](todo/TODO_08_ai_teacher_model_integration.md) - real AI teacher integration, pedagogy prompts, tools, and guardrails
- [TODO_09_content_package_generator_and_repo_readiness.md](todo/TODO_09_content_package_generator_and_repo_readiness.md) - real package generator, non-placeholder content repos, and license cleanup
- [TODO_10_world_class_teaching_quality.md](todo/TODO_10_world_class_teaching_quality.md) - expert teaching quality, production adaptation, evaluation, and excellence targets
...
- [OATutor](https://github.com/CAHLR/OATutor) - adaptive tutoring, Bayesian Knowledge Tracing, hints, accessibility, separate content repo
- [Open edX Platform](https://github.com/openedx/openedx-platform) - CMS/LMS separation, modular platform boundaries
- [Moodle](https://github.com/moodle/moodle) - personalized learning environments, mature role/community model
- [Kolibri](https://github.com/learningequality/kolibri) - offline-first content delivery
- [OpenStax TutorJS](https://github.com/openstax/tutor-js) - separate learner front end, realistic student workflows, e2e testing
- [Canvas LMS](https://github.com/instructure/canvas-lms) - large-scale LMS operations and course delivery patterns
- [Sakai](https://github.com/sakaiproject/sakai) - accessibility working group, localization, release/community discipline
